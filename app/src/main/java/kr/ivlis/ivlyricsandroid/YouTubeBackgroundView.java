...
public final class YouTubeBackgroundView extends FrameLayout {
    ...
    private String buildHtml(String videoId) {
        ...
        return "<!doctype html><html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">"
                ...
                + "iframe{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;pointer-events:none!important;border:0!important;outline:0!important;}"
                ...
                + "function sanitizeIframe(){try{var f=player&&player.getIframe&&player.getIframe();if(!f)return;f.setAttribute('referrerpolicy','origin');f.setAttribute('allow','autoplay; encrypted-media; picture-in-picture');f.setAttribute('tabindex','-1');f.setAttribute('aria-hidden','true');f.style.pointerEvents='none';f.style.border='0';}catch(e){}}"
