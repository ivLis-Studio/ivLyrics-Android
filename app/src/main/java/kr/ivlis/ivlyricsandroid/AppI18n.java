...
final class AppI18n {
    ...
    private static Map<String, String> hiStrings() {
        return strings(
                ...
                "toast.back_exit", "",
                "toast.ui_language_saved", "से बाहर निकलने के लिए फिर से वापस दबाएँ ऐप की भाषा सहेजी गई",
                ...
                "debug.play_pause", "",
                "debug.next", "को चलाएं/रोकें अगला",
                "debug.refresh", "",
                "debug.log", "को रिफ्रेश करें",
                ...
                "lyrics.button.translation_on", "",
                "lyrics.button.pronunciation_on", "पर अनुवाद",
                "lyrics.button.translation_plus", "पर उच्चारण अनुवाद+",
    ...
    private static Map<String, String> frStrings() {
        return strings(
                ...
                "preview.none", "Caché",
                "preview.original", "Prononciation originale",
    ...
    private static Map<String, String> arStrings() {
        return strings(
                ...
                "button.get_key", "احصل على المفتاح أدوات",
                "section.tools", "",
                ...
                "button.spotify_save", "Save Spotify API ذاكرة التخزين المؤقت للكلمات",
                "section.lyrics_cache", "",
                ...
                "onboarding.app_language_native", "",
                ...
                "preview.none", "مخفي",
                "preview.original", "النطق الأصلي",
                "preview.pronunciation", "",
                "preview.translation", "غلاف الألبوم",
    ...
    private static Map<String, String> faStrings() {
        return strings(
                ...
                "button.spotify_save", "Save Spotify API حافظه پنهان اشعار",
                "section.lyrics_cache", "",
    ...
    private static Map<String, String> ruStrings() {
        return strings(
                ...
                "preview.original", "Исходное произношение",
                "preview.pronunciation", "",
    ...
    private static Map<String, String> ptStrings() {
        return strings(
                ...
                "preview.none", "Oculto",
                "preview.original", "Pronúncia original",
                "preview.pronunciation", "",
    ...
    private static Map<String, String> bnStrings() {
        return strings(
                ...
                "loading.generating", "",
                "loading.pronunciation", "তৈরি করছে উচ্চারণ তৈরি হচ্ছে...",
    ...
    private static Map<String, String> itStrings() {
        return strings(
                ...
                "preview.none", "",
                "preview.original", "nascosto Pronuncia originale",
                "preview.pronunciation", "",
    ...
    private static Map<String, String> thStrings() {
        return strings(
                ...
                "preview.none", "ซ่อน",
                "preview.original", "การออกเสียง",
                "preview.pronunciation", "ดั้งเดิม",
                "preview.translation", "",
    ...
    private static Map<String, String> viStrings() {
        return strings(
                ...
                "preview.none", "Ẩn",
                "preview.original", "Phát âm gốc",
                "preview.pronunciation", "",
                "preview.translation", "Dịch",
    ...
    private static Map<String, String> idStrings() {
        return strings(
                ...
                "preview.original", "Pengucapan",
                "preview.pronunciation", "Asli",
