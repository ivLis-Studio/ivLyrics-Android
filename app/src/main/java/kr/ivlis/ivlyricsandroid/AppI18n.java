...
final class AppI18n {
    ...
    private static String[] spotifyShortcutStringsEn(String title, String desc, String menuTip) {
        return new String[]{
    ...
    private static Map<String, String> koStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "sync-data가 없는 일반 LRCLIB 싱크 가사에 글자별 균등 채움과 튐 효과를 적용합니다.",
                "section.player", "플레이어",
                ...
                "setting.blur", "블러",
                "setting.blur_desc", "앨범 커버와 그라데이션에 적용되는 블러 강도입니다.",
    ...
    private static Map<String, String> enStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Apply evenly timed character fill and bounce to regular LRCLIB synced lyrics without sync-data.",
                ...
                "setting.blur", "Blur",
                "setting.blur_desc", "Blur intensity for album cover and gradient backgrounds.",
    ...
    private static Map<String, String> zhCnStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "对没有 sync-data 的普通 LRCLIB 同步歌词应用均匀的逐字填充和弹跳效果。",
                "section.player", "播放器",
    ...
    private static Map<String, String> zhTwStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "對沒有 sync-data 的一般 LRCLIB 同步歌詞套用平均逐字填色與彈跳效果。",
                "section.player", "玩家",
    ...
    private static Map<String, String> jaStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "sync-dataのない通常のLRCLIB同期歌詞に、均等な文字ごとの塗りと跳ねる効果を適用します。",
    ...
    private static Map<String, String> hiStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "sync-data के बिना सामान्य LRCLIB सिंक गीतों पर समान अक्षर भराव और उछाल प्रभाव लागू करें।",
    ...
    private static Map<String, String> esStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Aplica relleno por caracteres y rebote uniforme a letras LRCLIB sincronizadas normales sin sync-data.",
    ...
    private static Map<String, String> frStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Applique un remplissage par caractère et un rebond régulier aux paroles LRCLIB synchronisées sans sync-data.",
    ...
    private static Map<String, String> arStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "تطبيق تعبئة أحرف منتظمة وارتداد على كلمات LRCLIB المتزامنة العادية بدون sync-data.",
                "section.player", "لاعب",
    ...
    private static Map<String, String> faStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "برای متن‌های همگام LRCLIB معمولی بدون sync-data، پرشدن کاراکتری یکنواخت و پرش اعمال می‌کند.",
                "section.player", "",
    ...
    private static Map<String, String> deStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Wendet gleichmäßige Zeichenfüllung und Sprungbewegung auf normale LRCLIB-Sync-Texte ohne sync-data an.",
    ...
    private static Map<String, String> ruStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Применяет равномерную посимвольную заливку и подпрыгивание к обычным синхронным текстам LRCLIB без sync-data.",
    ...
    private static Map<String, String> svStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Använder jämn teckenfyllning och studs på vanliga LRCLIB-synktexter utan sync-data.",
    ...
    private static Map<String, String> ptStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Aplica preenchimento por caractere e salto uniforme a letras LRCLIB sincronizadas comuns sem sync-data.",
    ...
    private static Map<String, String> bnStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "sync-data ছাড়া সাধারণ LRCLIB সিঙ্ক গানে সমান অক্ষর ভরাট ও বাউন্স প্রভাব প্রয়োগ করে।",
    ...
    private static Map<String, String> itStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Applica riempimento per carattere e rimbalzo uniforme ai testi LRCLIB sincronizzati senza sync-data.",
    ...
    private static Map<String, String> thStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "ใช้การเติมตัวอักษรและเด้งแบบสม่ำเสมอกับเนื้อเพลง LRCLIB ที่ซิงก์ปกติซึ่งไม่มี sync-data",
    ...
    private static Map<String, String> viStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Áp dụng tô từng ký tự đều và nảy cho lời LRCLIB đồng bộ thông thường không có sync-data.",
    ...
    private static Map<String, String> idStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Menerapkan isi karakter merata dan pantulan ke lirik LRCLIB sinkron biasa tanpa sync-data.",
    ...
    private static Map<String, String> msStrings() {
        return strings(
                ...
                "setting.synced_karaoke_animation_desc", "Menggunakan isian aksara sekata dan lantunan pada lirik LRCLIB segerak biasa tanpa sync-data.",
                "section.player", "Pemain",
