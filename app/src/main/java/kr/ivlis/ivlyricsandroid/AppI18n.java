...
final class AppI18n {
    ...
    private static String[] culturalAnnotationStrings(String language) {
        switch (language) {
            ...
            case "en": return new String[] {
                    ...
                    "Pretendard", "System", "Serif", "Monospace"
            };
            ...
            case "hi": return new String[] {
                    ...
                    "Pretendard", "सिस्टम", "सेरिफ़", "मोनोस्पेस"
            };
            case "es": return new String[] {
                    ...
                    "Pretendard", "Sistema", "Serif", "Monoespaciada"
            };
            case "fr": return new String[] {
                    ...
                    "Pretendard", "Système", "Avec empattements", "Chasse fixe"
            };
            case "ar": return new String[] {
                    ...
                    "Pretendard", "النظام", "مذيل", "أحادي المسافة"
            };
            case "fa": return new String[] {
                    ...
                    "Pretendard", "سیستم", "سریف", "تک‌فاصله"
            };
            case "de": return new String[] {
                    ...
                    "Pretendard", "System", "Serif", "Dicktengleich"
            };
            case "ru": return new String[] {
                    ...
                    "Pretendard", "Системный", "С засечками", "Моноширинный"
            };
            case "sv": return new String[] {
                    ...
                    "Pretendard", "System", "Serif", "Fast bredd"
            };
            case "pt": return new String[] {
                    ...
                    "Pretendard", "Sistema", "Serif", "Monoespaçada"
            };
            case "bn": return new String[] {
                    ...
                    "Pretendard", "সিস্টেম", "সেরিফ", "মনোস্পেস"
            };
            case "cs": return new String[] {
                    ...
                    "Pretendard", "Systém", "Patkové", "Neproporcionální"
            };
            case "it": return new String[] {
                    ...
                    "Pretendard", "Sistema", "Serif", "Monospazio"
            };
            case "th": return new String[] {
                    ...
                    "Pretendard", "ระบบ", "มีเชิง", "ความกว้างคงที่"
            };
            case "vi": return new String[] {
                    ...
                    "Pretendard", "Hệ thống", "Có chân", "Đơn cách"
            };
            case "id": return new String[] {
                    ...
                    "Pretendard", "Sistem", "Serif", "Monospace"
            };
            ...
            case "tr": return new String[] {
                    ...
                    "Pretendard", "Sistem", "Serif", "Eş aralıklı"
            };
        ...
        switch (normalize(lang)) {
            case "ko":
                return updateStringsValues(
                        "자동 업데이트",
                        "GitHub Releases에서 새 버전을 확인하고 다운로드할 릴리즈 페이지를 엽니다.",
                        "업데이트 확인",
                        "릴리즈 페이지",
                        "아직 업데이트를 확인하지 않았습니다.",
                        "최신 버전을 확인하는 중...",
            ...
            case "zh-CN":
                return updateStringsValues("自动更新", "从 GitHub Releases 检查新版本，并打开发布页面进行下载。", "检查更新", "发布页面", "尚未检查更新。", "正在检查最新版本...", "当前版本 %s 已是最新。", "有新版本 %s", "检查更新失败：%s", "有新版本可用", "当前：%s (%d)\n最新：%s (%d)\n\n%s", "没有发布说明。", "稍后", "打开发布页", "无法打开发布页面。", "正在检查更新", "当前已是最新版本。", "有新版本 %s。", "检查更新失败。");
            case "zh-TW":
                return updateStringsValues("自動更新", "從 GitHub Releases 檢查新版本，並開啟發佈頁面以下載。", "檢查更新", "發佈頁面", "尚未檢查更新。", "正在檢查最新版本...", "目前版本 %s 已是最新。", "有新版本 %s", "檢查更新失敗：%s", "有新版本可用", "目前：%s (%d)\n最新：%s (%d)\n\n%s", "沒有發佈說明。", "稍後", "開啟發佈頁", "無法開啟發佈頁面。", "正在檢查更新", "目前已是最新版本。", "有新版本 %s。", "檢查更新失敗。");
            case "ja":
                return updateStringsValues("自動アップデート", "GitHub Releases で新しいバージョンを確認し、ダウンロード用のリリースページを開きます。", "アップデート確認", "リリースページ", "まだアップデートを確認していません。", "最新バージョンを確認中...", "現在のバージョン %s は最新です。", "新しいバージョン %s があります", "アップデート確認に失敗: %s", "新しいバージョンがあります", "現在: %s (%d)\n最新: %s (%d)\n\n%s", "リリースノートはありません。", "あとで", "リリースを開く", "リリースページを開けません。", "アップデート確認中", "現在は最新バージョンです。", "新しいバージョン %s があります。", "アップデート確認に失敗しました。");
            case "hi":
                return updateStringsValues("ऑटो अपडेट", "GitHub Releases पर नया संस्करण जांचें और डाउनलोड के लिए रिलीज़ पेज खोलें।", "अपडेट जांचें", "रिलीज़ पेज", "अपडेट अभी जांचा नहीं गया।", "नया संस्करण जांचा जा रहा है...", "मौजूदा संस्करण %s नया है।", "नया संस्करण %s उपलब्ध है", "अपडेट जांच विफल: %s", "नया संस्करण उपलब्ध है", "मौजूदा: %s (%d)\nनया: %s (%d)\n\n%s", "रिलीज़ नोट नहीं हैं।", "बाद में", "रिलीज़ खोलें", "रिलीज़ पेज नहीं खुल सका।", "अपडेट जांचा जा रहा है", "आप नवीनतम संस्करण पर हैं।", "नया संस्करण %s उपलब्ध है।", "अपडेट जांच विफल।");
            case "es":
                return updateStringsValues("Actualización automática", "Busca nuevas versiones en GitHub Releases y abre la página de la versión para descargarla.", "Buscar actualizaciones", "Página de versiones", "Aún no se han comprobado actualizaciones.", "Comprobando la última versión...", "La versión actual %s está actualizada.", "Nueva versión %s disponible", "Error al comprobar actualizaciones: %s", "Hay una nueva versión", "Actual: %s (%d)\nNueva: %s (%d)\n\n%s", "No hay notas de versión.", "Más tarde", "Abrir versión", "No se puede abrir la página de la versión.", "Comprobando actualizaciones", "Ya tienes la última versión.", "Hay una nueva versión %s.", "No se pudo comprobar la actualización.");
            case "fr":
                return updateStringsValues("Mise à jour automatique", "Recherche les nouvelles versions sur GitHub Releases et ouvre la page de la version pour le téléchargement.", "Vérifier", "Page des versions", "Aucune vérification effectuée.", "Recherche de la dernière version...", "La version actuelle %s est à jour.", "Nouvelle version %s disponible", "Échec de la vérification: %s", "Nouvelle version disponible", "Actuelle: %s (%d)\nDernière: %s (%d)\n\n%s", "Aucune note de version.", "Plus tard", "Ouvrir la version", "Impossible d'ouvrir la page de la version.", "Vérification en cours", "Vous avez la dernière version.", "Nouvelle version %s disponible.", "Échec de la vérification.");
            case "ar":
                return updateStringsValues("التحديث التلقائي", "يتحقق من الإصدارات الجديدة على GitHub Releases ويفتح صفحة الإصدار للتنزيل.", "فحص التحديث", "صفحة الإصدارات", "لم يتم فحص التحديث بعد.", "جارٍ فحص أحدث إصدار...", "الإصدار الحالي %s هو الأحدث.", "يتوفر إصدار جديد %s", "فشل فحص التحديث: %s", "يتوفر إصدار جديد", "الحالي: %s (%d)\nالأحدث: %s (%d)\n\n%s", "لا توجد ملاحظات إصدار.", "لاحقًا", "فتح الإصدار", "تعذر فتح صفحة الإصدار.", "جارٍ فحص التحديث", "أنت على أحدث إصدار.", "يتوفر إصدار جديد %s.", "فشل فحص التحديث.");
            case "fa":
                return updateStringsValues("به‌روزرسانی خودکار", "نسخه‌های جدید را در GitHub Releases بررسی می‌کند و صفحه انتشار را برای دانلود باز می‌کند.", "بررسی به‌روزرسانی", "صفحه انتشار", "هنوز به‌روزرسانی بررسی نشده است.", "در حال بررسی آخرین نسخه...", "نسخه فعلی %s جدیدترین است.", "نسخه جدید %s موجود است", "بررسی به‌روزرسانی ناموفق بود: %s", "نسخه جدید موجود است", "فعلی: %s (%d)\nجدید: %s (%d)\n\n%s", "یادداشت انتشار موجود نیست.", "بعداً", "باز کردن انتشار", "صفحه انتشار باز نشد.", "در حال بررسی به‌روزرسانی", "شما آخرین نسخه را دارید.", "نسخه جدید %s موجود است.", "بررسی به‌روزرسانی ناموفق بود.");
            case "de":
                return updateStringsValues("Automatische Updates", "Prüft GitHub Releases auf neue Versionen und öffnet die Release-Seite zum Download.", "Updates prüfen", "Release-Seite", "Noch nicht nach Updates gesucht.", "Suche nach der neuesten Version...", "Version %s ist aktuell.", "Neue Version %s verfügbar", "Update-Prüfung fehlgeschlagen: %s", "Neue Version verfügbar", "Aktuell: %s (%d)\nNeu: %s (%d)\n\n%s", "Keine Release Notes vorhanden.", "Später", "Release öffnen", "Release-Seite konnte nicht geöffnet werden.", "Update wird geprüft", "Du hast die neueste Version.", "Neue Version %s verfügbar.", "Update-Prüfung fehlgeschlagen.");
            case "ru":
                return updateStringsValues("Автообновление", "Проверяет новые версии в GitHub Releases и открывает страницу релиза для скачивания.", "Проверить обновления", "Страница релиза", "Обновления еще не проверялись.", "Проверка последней версии...", "Текущая версия %s актуальна.", "Доступна новая версия %s", "Ошибка проверки обновления: %s", "Доступна новая версия", "Текущая: %s (%d)\nНовая: %s (%d)\n\n%s", "Нет заметок к релизу.", "Позже", "Открыть релиз", "Не удалось открыть страницу релиза.", "Проверка обновлений", "У вас последняя версия.", "Доступна новая версия %s.", "Не удалось проверить обновления.");
            case "sv":
                return updateStringsValues("Automatisk uppdatering", "Söker efter nya versioner på GitHub Releases och öppnar releasesidan för nedladdning.", "Sök uppdatering", "Release-sida", "Ingen uppdatering har kontrollerats.", "Kontrollerar senaste version...", "Version %s är aktuell.", "Ny version %s finns", "Uppdateringskontroll misslyckades: %s", "Ny version finns", "Nuvarande: %s (%d)\nSenaste: %s (%d)\n\n%s", "Inga release notes.", "Senare", "Öppna release", "Det gick inte att öppna releasesidan.", "Kontrollerar uppdatering", "Du har senaste versionen.", "Ny version %s finns.", "Kunde inte kontrollera uppdatering.");
            case "pt":
                return updateStringsValues("Atualização automática", "Verifica novas versões no GitHub Releases e abre a página da versão para download.", "Verificar atualizações", "Página da versão", "Atualizações ainda não verificadas.", "Verificando a versão mais recente...", "A versão atual %s está atualizada.", "Nova versão %s disponível", "Falha ao verificar atualização: %s", "Há uma nova versão", "Atual: %s (%d)\nNova: %s (%d)\n\n%s", "Sem notas de versão.", "Depois", "Abrir versão", "Não foi possível abrir a página da versão.", "Verificando atualização", "Você já está na versão mais recente.", "Nova versão %s disponível.", "Falha ao verificar atualização.");
            case "bn":
                return updateStringsValues("স্বয়ংক্রিয় আপডেট", "GitHub Releases-এ নতুন সংস্করণ দেখে এবং ডাউনলোডের জন্য রিলিজ পেজ খোলে।", "আপডেট দেখুন", "রিলিজ পেজ", "এখনও আপডেট দেখা হয়নি।", "নতুন সংস্করণ দেখা হচ্ছে...", "বর্তমান সংস্করণ %s সর্বশেষ।", "নতুন সংস্করণ %s আছে", "আপডেট পরীক্ষা ব্যর্থ: %s", "নতুন সংস্করণ আছে", "বর্তমান: %s (%d)\nনতুন: %s (%d)\n\n%s", "রিলিজ নোট নেই।", "পরে", "রিলিজ খুলুন", "রিলিজ পেজ খোলা যায়নি।", "আপডেট দেখা হচ্ছে", "আপনি সর্বশেষ সংস্করণে আছেন।", "নতুন সংস্করণ %s আছে।", "আপডেট পরীক্ষা ব্যর্থ।");
            case "it":
                return updateStringsValues("Aggiornamento automatico", "Controlla le nuove versioni su GitHub Releases e apre la pagina della release per il download.", "Controlla aggiornamenti", "Pagina release", "Aggiornamenti non ancora controllati.", "Controllo dell'ultima versione...", "La versione attuale %s è aggiornata.", "Nuova versione %s disponibile", "Controllo aggiornamenti non riuscito: %s", "È disponibile una nuova versione", "Attuale: %s (%d)\nNuova: %s (%d)\n\n%s", "Nessuna nota di rilascio.", "Più tardi", "Apri release", "Impossibile aprire la pagina della release.", "Controllo aggiornamenti", "Hai già l'ultima versione.", "Nuova versione %s disponibile.", "Controllo aggiornamenti non riuscito.");
            case "th":
                return updateStringsValues("อัปเดตอัตโนมัติ", "ตรวจสอบเวอร์ชันใหม่ใน GitHub Releases และเปิดหน้ารีลีสเพื่อดาวน์โหลด", "ตรวจสอบอัปเดต", "หน้ารีลีส", "ยังไม่ได้ตรวจสอบอัปเดต", "กำลังตรวจสอบเวอร์ชันล่าสุด...", "เวอร์ชันปัจจุบัน %s เป็นล่าสุดแล้ว", "มีเวอร์ชันใหม่ %s", "ตรวจสอบอัปเดตล้มเหลว: %s", "มีเวอร์ชันใหม่", "ปัจจุบัน: %s (%d)\nล่าสุด: %s (%d)\n\n%s", "ไม่มีบันทึกรีลีส", "ภายหลัง", "เปิดรีลีส", "ไม่สามารถเปิดหน้ารีลีสได้", "กำลังตรวจสอบอัปเดต", "คุณใช้เวอร์ชันล่าสุดแล้ว", "มีเวอร์ชันใหม่ %s", "ตรวจสอบอัปเดตล้มเหลว");
            case "vi":
                return updateStringsValues("Tự động cập nhật", "Kiểm tra phiên bản mới trên GitHub Releases và mở trang phát hành để tải xuống.", "Kiểm tra cập nhật", "Trang phát hành", "Chưa kiểm tra cập nhật.", "Đang kiểm tra phiên bản mới nhất...", "Phiên bản hiện tại %s là mới nhất.", "Có phiên bản mới %s", "Kiểm tra cập nhật thất bại: %s", "Có phiên bản mới", "Hiện tại: %s (%d)\nMới nhất: %s (%d)\n\n%s", "Không có ghi chú phát hành.", "Để sau", "Mở bản phát hành", "Không thể mở trang phát hành.", "Đang kiểm tra cập nhật", "Bạn đang dùng phiên bản mới nhất.", "Có phiên bản mới %s.", "Kiểm tra cập nhật thất bại.");
            case "id":
                return updateStringsValues("Pembaruan otomatis", "Memeriksa versi baru di GitHub Releases dan membuka halaman rilis untuk mengunduh.", "Periksa pembaruan", "Halaman rilis", "Pembaruan belum diperiksa.", "Memeriksa versi terbaru...", "Versi saat ini %s sudah terbaru.", "Versi baru %s tersedia", "Gagal memeriksa pembaruan: %s", "Versi baru tersedia", "Saat ini: %s (%d)\nTerbaru: %s (%d)\n\n%s", "Tidak ada catatan rilis.", "Nanti", "Buka rilis", "Tidak dapat membuka halaman rilis.", "Memeriksa pembaruan", "Anda sudah memakai versi terbaru.", "Versi baru %s tersedia.", "Gagal memeriksa pembaruan.");
            case "ms":
                return updateStringsValues("Kemas kini automatik", "Menyemak versi baharu di GitHub Releases dan membuka halaman keluaran untuk dimuat turun.", "Semak kemas kini", "Halaman keluaran", "Kemas kini belum disemak.", "Menyemak versi terkini...", "Versi semasa %s ialah yang terkini.", "Versi baharu %s tersedia", "Semakan kemas kini gagal: %s", "Versi baharu tersedia", "Semasa: %s (%d)\nTerkini: %s (%d)\n\n%s", "Tiada nota keluaran.", "Nanti", "Buka keluaran", "Halaman keluaran tidak dapat dibuka.", "Menyemak kemas kini", "Anda sudah menggunakan versi terkini.", "Versi baharu %s tersedia.", "Semakan kemas kini gagal.");
            case "tr":
                return updateStringsValues("Otomatik Güncellemeler", "GitHub Releases üzerinden yeni sürümleri kontrol eder ve indirmek için sürüm sayfasını açar.", "Güncellemeleri Kontrol Et", "Sürüm Sayfası", "Güncellemeler henüz kontrol edilmedi.", "En son sürüm kontrol ediliyor...", "Geçerli sürüm %s güncel.", "Yeni sürüm %s mevcut", "Güncelleme kontrolü başarısız: %s", "Yeni Sürüm Mevcut", "Geçerli: %s (%d)\nEn son: %s (%d)\n\n%s", "Sürüm notu yok.", "Daha Sonra", "Sürümü Aç", "Sürüm sayfası açılamadı.", "Güncellemeler kontrol ediliyor", "En son sürümü kullanıyorsunuz.", "Yeni sürüm %s mevcut.", "Güncelleme kontrolü başarısız.");
            default:
                return updateStringsValues("Automatic Updates", "Checks GitHub Releases for new versions and opens the release page for download.", "Check Updates", "Release Page", "Updates have not been checked yet.", "Checking the latest version...", "Current version %s is up to date.", "New version %s available", "Update check failed: %s", "New Version Available", "Current: %s (%d)\nLatest: %s (%d)\n\n%s", "No release notes.", "Later", "Open Release", "Could not open the release page.", "Checking updates", "You are on the latest version.", "New version %s is available.", "Update check failed.");
        }
    }
    ...
    private static Map<String, String> csStrings() {
        return strings(
                ...
                "section.app_update_desc", "Vyhledá nové verze na GitHub Releases a otevře stránku vydání ke stažení.",
                ...
                "update.open_failed", "Nelze otevřít stránku vydání.",
